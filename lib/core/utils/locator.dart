...
import 'package:viez/core/data/data_source/physical_activity_data_source.dart';
import 'package:viez/core/data/data_source/tracked_day_data_source.dart';
import 'package:viez/core/data/data_source/user_activity_data_source.dart';
import 'package:viez/core/data/data_source/user_data_source.dart';
...
import 'package:viez/core/data/repository/tracked_day_repository.dart';
...
import 'package:viez/core/domain/usecase/add_config_usecase.dart';
import 'package:viez/core/domain/usecase/add_intake_usecase.dart';
import 'package:viez/core/domain/usecase/add_tracked_day_usecase.dart';
import 'package:viez/core/domain/usecase/add_user_activity_usercase.dart';
import 'package:viez/core/domain/usecase/add_user_usecase.dart';
import 'package:viez/core/domain/usecase/delete_intake_usecase.dart';
import 'package:viez/core/domain/usecase/delete_user_activity_usecase.dart';
import 'package:viez/core/domain/usecase/get_config_usecase.dart';
import 'package:viez/core/domain/usecase/get_intake_usecase.dart';
import 'package:viez/core/domain/usecase/get_physical_activity_usecase.dart';
import 'package:viez/core/domain/usecase/get_tracked_day_usecase.dart';
import 'package:viez/core/domain/usecase/get_user_activity_usecase.dart';
import 'package:viez/core/domain/usecase/get_user_usecase.dart';
import 'package:viez/core/utils/hive_db_provider.dart';
import 'package:viez/core/utils/ont_image_cache_manager.dart';
import 'package:viez/core/utils/secure_app_storage_provider.dart';
import 'package:viez/bloc/activity_detail_bloc.dart';
import 'package:viez/bloc/activities_bloc.dart';
import 'package:viez/bloc/recent_activities_bloc.dart';
import 'package:viez/data/data_sources/fdc_data_source.dart';
import 'package:viez/data/data_sources/off_data_source.dart';
import 'package:viez/data/data_sources/sp_fdc_data_source.dart';
import 'package:viez/data/repository/products_repository.dart';
import 'package:viez/usecase/search_products_usecase.dart';
...
import 'package:viez/bloc/calendar_day_bloc.dart';
import 'package:viez/bloc/diary_bloc.dart';
import 'package:viez/bloc/edit_meal_bloc.dart';
import 'package:viez/bloc/home_bloc.dart';
import 'package:viez/bloc/meal_detail_bloc.dart';
import 'package:viez/bloc/onboarding_bloc.dart';
import 'package:viez/bloc/profile_bloc.dart';
import 'package:viez/usecase/search_product_by_barcode_usecase.dart';
import 'package:viez/bloc/scanner_bloc.dart';
import 'package:viez/bloc/settings_bloc.dart';
